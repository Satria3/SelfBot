...
#                else:
          ...
          # elif "All mid" == msg.text:
            ...
            elif "Satria:" in msg.text:
                string = msg.text.replace("Satria:","")
              ...
              #  if len(string.decode('utf-8')) <= 20:
                   ...
                   # pb2.updateProfile(profile)
                    #satria.sendText(msg.to,"􀜁􀇔􏿿semua nama BotTrox telah di update menjadi\n👉 " + string + "👈")
...
#--------------------------------------------------------
                ...
                if msg.toType == 1:
                    ...
                    turl = satria.getUserTicket(tid)
                    satria.sendText(msg.to,"line://ti/p" + turl)
                else:
                    satria.sendText(msg.to,"error")
...
#-----------------------------------------------------------speed
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += "😂" +satria.getContact(mm).displayName + "\n"
...
#---------------------- = NUKE = ------------------
                ...
                if msg.toType == 2:
                    ...
                    start = time.time()
                    satria.sendText(msg.to, "Nuke Speed")
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                ...
                                satria.sendText(msg,to,"Nuke Succes Bos")
#-------------------- = NUKE FINISH = ----------------------------- 
